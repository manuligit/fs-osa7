...
describe('list helpers', () => {
  ...
  describe('most likes', () => {
    test('empty list should return no blog', () => {
    ...
    test('list with multiple items should return the blogpost with most likes', () => {
      //const blogs = [blogPost, blogPost2, blogPost]
  ...
  describe('most blogs', () => {
    test('empty list should not return author', () => {
      const result = listHelper.mostBlogs([])
      expect(result).toEqual({})
    })

    test('one blog should return one author with one post', () => {
      const result = listHelper.mostBlogs(listWithOneBlog)
      expect(result).toEqual({author: 'Edsger W. Dijkstra', blogs:1})
    })

    test('list with multiple items should return the author with most blog posts', () => {
